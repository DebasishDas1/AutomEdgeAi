...
import { Send, MessageCircle, Mail, X, Linkedin, Instagram, Facebook, ArrowRight } from "lucide-react";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-start">
                ...
                >
                    <div className="flex flex-col items-center lg:items-start">
                        <h2 className="text-5xl md:text-7xl font-outfit font-[800] mb-6 tracking-tighter leading-none">Let's talk scale.</h2>
                        <p className="text-xl md:text-2xl text-muted-foreground font-sans font-medium tracking-tight max-w-xl">
                            Ready to automate your inquiries? Fill out the form and our team will get back to you within 60 minutes.
                        </p>
                    </div>
                ...
                >
                    <div className="space-y-8 w-full">
                        ...
                        <div className="space-y-6">
                            ...
                            >
                                ...
                                <div>
                                    <div className="font-outfit font-[800] text-2xl tracking-tight">WhatsApp Us</div>
                                    <div className="text-lg text-muted-foreground font-sans font-medium leading-tight">Instant support for urgent inquiries.</div>
                                </div>
                            ...
                            >
                                ...
                                <div>
                                    <div className="font-outfit font-[800] text-2xl tracking-tight">Email Us</div>
                                    <div className="text-lg text-muted-foreground font-sans font-medium tracking-tight">hello@automedge.com</div>
                                </div>
                                <ArrowRight className="w-8 h-8 ml-auto opacity-0 group-hover:opacity-100 transition-all -translate-x-4 group-hover:translate-x-0 hidden sm:block" />
                            </a>
                        </div>
                    ...
                    <div className="space-y-8">
                        <h3 className="text-xl font-outfit font-black tracking-[0.3em] uppercase opacity-40">Follow Us</h3>
