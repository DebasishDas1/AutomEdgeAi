    ...
    <section id="solution" className="py-24 px-6 bg-muted/30 scroll-mt-24">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-6 py-2 rounded-full border border-primary/20 bg-primary/5 text-primary font-black text-xs uppercase tracking-[0.2em]">
            The Solution
          </div>

          <h2 className="text-5xl md:text-7xl font-outfit font-extrabold leading-tight mb-6 tracking-tighter mt-6">
