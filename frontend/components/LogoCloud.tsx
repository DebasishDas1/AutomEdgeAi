    ...
    <section className="py-24 px-6 bg-muted/20 border-y border-border/10">
      <div className="max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-wrap items-center justify-center gap-x-12 md:gap-x-20 gap-y-12 opacity-80 grayscale group hover:grayscale-0 transition-all duration-700">
          ...
          <span className="text-2xl font-black font-inter italic tracking-tight underline-offset-8 underline decoration-accent decoration-[6px]">
            HOUSECALL PRO
          </span>
          <span className="text-3xl font-black tracking-widest uppercase">
            Jobber
          </span>
          <span className="text-4xl font-outfit font-black tracking-normal italic text-foreground">
            XOi
          </span>
          <span className="text-3xl font-black font-inter tracking-widest border-4 border-foreground px-6 py-2">
            FIELDEDGE
          </span>
        </div>
      </div>
