# api/v1/chat/hvac.py
# HVAC chat endpoints.
# Agent: Alex — AC not cooling, no heat, strange noises
#
# POST /chat/hvac/start    — new session, returns AI greeting
# POST /chat/hvac/message  — user turn, returns AI reply
#
...
@router.post(
    ...
    status_code=201,
    summary="Start a HVAC chat session",
    description=(
        "Creates a new chat session with Alex, our HVAC specialist. "
...
@router.post(
    ...
    summary="Send a message in a HVAC chat",
    description=(
        "Sends a user message to Alex and returns the AI reply. "
