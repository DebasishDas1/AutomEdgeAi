...
# Plumbing chat endpoints.
# Agent: Sam — burst pipe, slow drain, running toilet, no hot water
#
# POST /chat/plumbing/start    — new session, returns AI greeting
# POST /chat/plumbing/message  — user turn, returns AI reply
#
...
@router.post(
    ...
    status_code=201,
    summary="Start a Plumbing chat session",
    description=(
        "Creates a new chat session with Sam, our Plumbing specialist. "
...
@router.post(
    ...
    summary="Send a message in a Plumbing chat",
    description=(
        "Sends a user message to Sam and returns the AI reply. "
